...
experiment_configurations = [
    ...
    {'experiment_id': 'demo.A.1r',
     ...
     'model_names': ['Feld', 'ZafarDI', 'ThresholdOptimizer', 'hybrids', ],
     'eps': BASE_EPS_V1,
     'base_model_code': ['lr'],
     'random_seeds': [0],
     'constraint_code': 'dp',
    ...
    {'experiment_id': 'acs_h_gs1_1.test',
     ...
     'model_names': ['hybrids'],
     'eps': BASE_EPS_V1,
     'expgrad_fractions': TRAIN_FRACTIONS_v1,
     'grid_fractions': [1],
     'base_model_code': ['lr', 'lgbm'],
     'random_seeds': RANDOM_SEEDS_v1,
    ...
    #  'model_names': ['hybrids'],
    #  'eps': base_eps_v1,
    #  'expgrad_fractions': exp_fraction_list_v1,
    #  'grid_fractions': [1],
    #  'base_model_code': ['lgbm', ],
    #  'random_seeds': range(1),
    #  'train_test_seeds': range(1),
    ...
    {'experiment_id': 'f_eta0_eps.3.2E',
     ...
     'train_test_fold': RANDOM_SEEDs_RESTRICTED_V1,
     'constraint_code': 'dp',
     'model_params': eta_params_restricted_v2,
     },
    ...
    {'experiment_id': 'sigmod_h_exp_1.0',  # done
     ...
     'params': ['--redo_exp'],
     'eps': BASE_EPS_V1,
     'expgrad_fractions': TRAIN_FRACTIONS_SMALLER_DATASETS_v1,
     'grid_fractions': [1],
     'base_model_code': ['lr', 'lgbm'],
     'random_seeds': RANDOM_SEEDS_v1,
     'train_test_seeds': RANDOM_SEEDS_v1,
